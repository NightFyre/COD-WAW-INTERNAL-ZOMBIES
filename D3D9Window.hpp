...
namespace CODWAW_SP {
	...
	public:
		...
		void ConvertToRange(Vector2& Point, ImVec2 Screen);
		bool WorldToScreen(Vector3& vecOrigin, Vector2& vecscreen, float* matrix, float windowWidth, float windowHeight);
